$(document).ready(function (){
    ...
    navbtn_pub.onclick = () => {$(window).scrollTop(toNextScroll*((pageCount*centerValue)+1)+(toNextScroll/2))};
        const navbtn_NaGyeongStone = document.querySelector('.navbtn_NaGyeongStone');
        navbtn_NaGyeongStone.onclick = () => {$(window).scrollTop(toNextScroll*((pageCount*centerValue)+NaGyeongStoneProcedure)+(toNextScroll/2))};
        const navbtn_gnuboard = document.querySelector('.navbtn_gnuboard');
        navbtn_gnuboard.onclick = () => {$(window).scrollTop(toNextScroll*((pageCount*centerValue)+gnuboardProcedure)+(toNextScroll/2))};
        const navbtn_univ = document.querySelector('.navbtn_univ');
        navbtn_univ.onclick = () => {$(window).scrollTop(toNextScroll*((pageCount*centerValue)+univProcedure)+(toNextScroll/2))};
        const navbtn_livart = document.querySelector('.navbtn_livart');
        navbtn_livart.onclick = () => {$(window).scrollTop(toNextScroll*((pageCount*centerValue)+livartProcedure)+(toNextScroll/2))};
        const navbtn_downy = document.querySelector('.navbtn_downy');
        navbtn_downy.onclick = () => {$(window).scrollTop(toNextScroll*((pageCount*centerValue)+downyProcedure)+(toNextScroll/2))};
        const navbtn_touslesjours = document.querySelector('.navbtn_touslesjours');
        navbtn_touslesjours.onclick = () => {$(window).scrollTop(toNextScroll*((pageCount*centerValue)+touslesjoursProcedure)+(toNextScroll/2))};
    const navbtn_dsi = document.querySelector('.navbtn_dsi');
    navbtn_dsi.onclick = () => {$(window).scrollTop(toNextScroll*((pageCount*centerValue)+designWorksProcedure)+(toNextScroll/2))};
    const navbtn_prf = document.querySelector('.navbtn_prf');
    navbtn_prf.onclick = () => {$(window).scrollTop(toNextScroll*((pageCount*centerValue)+profileProcedure)+(toNextScroll/2))};
